...
export default function Sidebar({ isOpen }) {
  // Leer el rol del usuario desde localStorage para renderizado condicional
  ...
  if (isAdmin) {
    menuItems = [
      { icon: Users, label: 'Catedráticos', path: '/dashboard/catedraticos', id: 'tour-catedraticos' }
    ];
  } else {
    menuItems = [
  ...
  return (
    <aside
      className={`${isOpen ? 'w-64 sm:w-72' : 'w-20 hidden md:flex'
