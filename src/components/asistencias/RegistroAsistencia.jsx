  ...
  if (isTokenExpired()) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 text-center text-red-500">
           <AlertCircle className="w-16 h-16 mx-auto mb-4" />
           <h2 className="text-2xl font-bold mb-2">El código QR ha expirado</h2>
           <p className="text-gray-600">Este QR ya no es válido para registrar asistencia. Si llegaste tarde, por favor solicítale al catedrático que regenere el código QR.</p>
        </div>
      </div>
    );
  }
